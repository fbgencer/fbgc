...
fbgc_object * add_two_fbgc_object(struct fbgc_object *obj,struct fbgc_object *obj2){
    struct  fbgc_double_object * io1 =  (struct fbgc_double_object*) obj;
    struct  fbgc_double_object * io2 =  (struct fbgc_double_object*) obj2;
    io1->data += io2->data;
...
int main(){
    ...
    struct fbgc_object * o1 = new_fbgc_double_object(3.141516);
    struct fbgc_object * o2 = new_fbgc_double_object(7.2323);
    struct fbgc_object * o3 = new_fbgc_string_object("fBGencer");
    struct fbgc_object * o4 = new_fbgc_string_object(" <3 elif :)))) ");
    struct fbgc_object * o5 = new_fbgc_int_object(83);

    o1 = add_two_fbgc_object(o1,o2);
